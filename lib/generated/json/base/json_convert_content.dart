...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case ProjectCategoryEntity:
			...
			return homeArticleDataDatasTagFromJson(data as HomeArticleDataDatasTag, json) as T;			case LoginEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case ProjectCategoryEntity:
			...
			return homeArticleDataDatasTagToJson(data as HomeArticleDataDatasTag);			case LoginEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'ProjectCategoryEntity':
			...
			return HomeArticleDataDatasTag().fromJson(json);			case 'LoginEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'ProjectCategoryEntity':
			...
			return List<HomeArticleDataDatasTag>();			case 'LoginEntity':
