...
homeArticleDataDatasTagFromJson(
    HomeArticleDataDatasTag data, Map<String, dynamic> json) {
  if (json['name'] != null) {
...
Map<String, dynamic> homeArticleDataDatasTagToJson(
    HomeArticleDataDatasTag entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
