...
knowledgeSystemEntityFromJson(KnowledgeSystemEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
...
knowledgeSystemDataFromJson(KnowledgeSystemData data, Map<String, dynamic> json) {
...
knowledgeSystemDatachildFromJson(KnowledgeSystemDatachild data, Map<String, dynamic> json) {
	if (json['children'] != null) {
...
Map<String, dynamic> knowledgeSystemDatachildToJson(KnowledgeSystemDatachild entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	if (entity.children != null) {
		data['children'] =  [];
	}
